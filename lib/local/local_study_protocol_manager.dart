...
// API keys used in this local test protocol.
// Do NOT USE in real deployable protocols.
final _openWeatherApiKey = '66cfd8479930ed026605bc79c929ef76';
final _airQualityApiKey = '9e538456b2b85c92647d8b65090e29f957638c77';
...
class LocalStudyProtocolManager implements StudyProtocolManager {
  ...
  SmartphoneStudyProtocol getSingleUserStudyProtocol(String name) {
    ...
    WeatherService weatherService = WeatherService(apiKey: _openWeatherApiKey);
    ...
    AirQualityService airQualityService =
        AirQualityService(apiKey: _airQualityApiKey);
