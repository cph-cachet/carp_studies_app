      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Text(locale.translate(title), style: Theme.of(context).textTheme.titleLarge!)),
            const SizedBox(height: 10),
            Text(locale.translate(description), style: Theme.of(context).textTheme.labelLarge!),
          ],
        ),
      ),
      bottomSheet: Row(
